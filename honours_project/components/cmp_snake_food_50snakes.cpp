#include "stdafx.h"
#include "../define.h"
#include "cmp_snake_food_50snakes.h"
...
void Crystal50::spawn(std::vector<Vector2i> obstacles, Crystal50 crystal[NB_CRYSTAL50]) {
...
void Crystal50::display(RenderWindow& win) {
	win.draw(sprite);
}

Vector2i Crystal50::getPosition() const{
	return pos;
}