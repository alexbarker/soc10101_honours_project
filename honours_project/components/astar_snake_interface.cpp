#include "stdafx.h"
#include <iostream>
#include "astar_snake_interface.h"
#include "../ai/astar.h"
...
Gui::Gui() {
	...
	title_score.setCharacterSize(W_HEIGHT / 10);
	...
	score.setCharacterSize(W_HEIGHT / 14);
	...
	game_over.setCharacterSize(W_HEIGHT / 10);
	...
	game_over_score.setCharacterSize(W_HEIGHT / 14);
